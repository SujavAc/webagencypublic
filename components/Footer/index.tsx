        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  At A-tech web agency, we specialize in transforming digital aspirations into reality. With a passion for innovation and a commitment to excellence, we craft immersive online experiences that captivate audiences and drive business growth. Our dynamic team of experts combines creativity with cutting-edge technology, ensuring your web presence not only meets but exceeds industry standards. Whether you are starting from scratch or seeking to enhance an existing platform, trust us to deliver tailored solutions that leave a lasting impact. Welcome to a world where your digital success is our top priority.
                </p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © {new Date().getFullYear()}, A-Tech Web Agency, All Rights Reserved{" "}
            </p>
          </div>
        </div>
