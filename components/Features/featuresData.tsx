...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: `<svg width="40" height="41" viewBox="0 0 40 41" className="fill-current">
        <path
          opacity="0.5"
    ...
    paragraph:
      "Our Customized Design service goes beyond aesthetics, crafting a digital identity that resonates with your brand. From color schemes to layout, we meticulously tailor every aspect to create a visually stunning and memorable online presence. Your website becomes a unique reflection of your business, leaving a lasting impression on visitors.",
  },
  {
    id: 1,
    icon: `<svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path
          opacity="0.5"
    ...
    paragraph:
      "Embrace the future of online engagement with Responsive Development. Our expert team ensures that your website seamlessly adapts to various screen sizes and devices, providing a consistently exceptional user experience. Whether accessed on a desktop, tablet, or smartphone, your website remains visually appealing and functional, maximizing accessibility for a diverse audience.",
  },
  {
    id: 1,
    icon: `<svg width="40" height="42" viewBox="0 0 40 42" className="fill-current">
        <path
          opacity="0.5"
    ...
    paragraph:
      "Elevate your online visibility with our SEO Optimization service. We employ advanced strategies to enhance your website's search engine ranking, driving organic traffic and increasing your digital footprint. From keyword optimization to meta tags, we meticulously optimize every element, ensuring your website is not just a digital presence but a discoverable asset in the vast online landscape.",
  },
  {
    id: 1,
    icon: `<svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
    ...
    paragraph:
      "Transform your business into an online powerhouse with our E-commerce Integration service. Seamlessly blending design and functionality, we create secure and user-friendly online storefronts. From product listings to payment gateways, we ensure a smooth and engaging shopping experience, empowering your business to thrive in the competitive digital marketplace. Welcome to a new era of online commerce where success is just a click away.",
  },
  {
    id: 1,
    icon: `<svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
    ...
    paragraph:
      "User experience is at the forefront of our User-Friendly Interface service. We design interfaces that are not only visually appealing but also intuitively navigable. Every click, scroll, and interaction is crafted to enhance user engagement, fostering a positive experience that keeps visitors coming back for more. Your website becomes a user-centric hub, seamlessly connecting with your audience.",
  },
  {
    id: 1,
    icon: `<svg width="40" height="45" viewBox="0 0 40 45" className="fill-current">
        <path
          opacity="0.5"
    ...
    paragraph:
      "Future-proof your online presence with our Scalability and Performance service. We build websites with scalability in mind, ensuring they can handle increased traffic and evolving business needs without compromising performance. Your website becomes a dynamic platform that grows with your ambitions, providing a seamless experience for users no matter the scale.",
  },
  {
    id: 1,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512" className="fill-current"><path d="M256 0c4.6 0 9.2 1 13.4 2.9L457.7 82.8c22 9.3 38.4 31 38.3 57.2c-.5 99.2-41.3 280.7-213.6 363.2c-16.7 8-36.1 8-52.8 0C57.3 420.7 16.5 239.2 16 140c-.1-26.2 16.3-47.9 38.3-57.2L242.7 2.9C246.8 1 251.4 0 256 0zm0 66.8V444.8C394 378 431.1 230.1 432 141.4L256 66.8l0 0z"/></svg>`,
    title: "Security Measures",
    paragraph:
      "Rest easy knowing your digital assets are safeguarded with our Security Measures service. We implement robust security protocols to protect your website and user data from potential threats. From encryption to regular security audits, we prioritize the confidentiality and integrity of your online presence, fostering trust and confidence among your users.",
  },
  {
    id: 1,
    icon: `<svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512" className="fill-current"><path d="M64 64c0-17.7-14.3-32-32-32S0 46.3 0 64V400c0 44.2 35.8 80 80 80H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H80c-8.8 0-16-7.2-16-16V64zm406.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L320 210.7l-57.4-57.4c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L240 221.3l57.4 57.4c12.5 12.5 32.8 12.5 45.3 0l128-128z"/></svg>`,
    title: "Analytics Integration",
    paragraph:
      "Gain valuable insights into your website's performance with our Analytics Integration service. We implement advanced analytics tools to track user behavior, monitor traffic patterns, and provide actionable data for informed decision-making. Understand your audience, measure the effectiveness of your strategies, and refine your online presence based on real-time data.",
  },
  {
    id: 1,
    ...
    paragraph:
      "Enjoy peace of mind with our Ongoing Support and Maintenance service. Our dedicated support team is here to ensure your website remains secure, up-to-date, and aligned with evolving industry standards. From troubleshooting issues to implementing updates, we provide continuous support, allowing you to focus on your core business while we take care of the technical aspects.",
  },
];
