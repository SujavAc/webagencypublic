...
import { CommonTypographyComponenet } from "@/dashboard/editor/components/common/dataDisplay/Typography";
import CommonSvg from "@/dashboard/editor/components/common/dataDisplay/svg";

const ErrorPage = () => {
  return (
    <CommonContainerLayout maxWidth="xl" sx={{ marginTop: "auto" }}>
      <CommonBoxContainer
        sx={{
          display: "flex",
      ...
      >
        ...
        >
          ...
          >
            ...
            <CommonButtonWrapper href="/" variant="outlined">
              Back to Homepage
            </CommonButtonWrapper>
          </CommonBoxContainer>
        </CommonBoxContainer>
